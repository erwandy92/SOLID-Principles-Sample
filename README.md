...
Designed By Robert C. Martin (Nickname: Uncle Bob)

## S - Single Responsibility Principle (SRP)
![Ugonna Thelma SRP](https://miro.medium.com/v2/resize:fit:1100/format:webp/1*P3oONz9Da3Tc1w97fMV73Q.png)

A class should have a single responsibility
> Explanation by Ugonna Thelma (Medium)
> ---
